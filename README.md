...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lingering-surf-0e8c)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-surf-0e8c
```

A live public deployment of this template is available at [https://lingering-surf-0e8c.templates.workers.dev](https://lingering-surf-0e8c.templates.workers.dev)
